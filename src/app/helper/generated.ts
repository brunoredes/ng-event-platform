...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, title: string, availableAt?: any | null, lessonType: LessonType, slug?: string | null, videoId: string }> };
...
export const CreationSubscriberDocument = gql`
  ...
  export class CreationSubscriberGQL extends Apollo.Mutation<CreationSubscriberMutation, CreationSubscriberMutationVariables> {
    override document = CreationSubscriberDocument;
...
export const GetLessonBySlugDocument = gql`
  ...
  export class GetLessonBySlugGQL extends Apollo.Query<GetLessonBySlugQuery, GetLessonBySlugQueryVariables> {
    override document = GetLessonBySlugDocument;
...
export const GetLessonsDocument = gql`
  ...
  export class GetLessonsGQL extends Apollo.Query<GetLessonsQuery, GetLessonsQueryVariables> {
    override document = GetLessonsDocument;
